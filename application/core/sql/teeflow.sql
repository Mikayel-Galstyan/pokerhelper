...
) ENGINE=InnoDB AUTO_INCREMENT=84082 DEFAULT CHARSET=utf8;
...
CREATE TABLE `history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2969109 DEFAULT CHARSET=latin1;
...
CREATE TABLE `history_info` (
  ...
  `course_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2908322 DEFAULT CHARSET=latin1;
...
CREATE TABLE `test_games` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=413149 DEFAULT CHARSET=latin1;
